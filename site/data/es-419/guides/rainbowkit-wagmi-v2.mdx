...
Los desarrolladores continúan teniendo control total sobre la Lista de Billeteras Personalizadas para enfatizar las billeteras preferidas por los usuarios finales. It is encouraged that you continue to include the `injectedWallet` and `walletConnectWallet` in your list to support all platforms.
