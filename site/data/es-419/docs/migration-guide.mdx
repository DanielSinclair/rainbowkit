...
Nota: wagmi ya no utiliza internamente el paquete `ethers`. Pero si confías en la API de [Autenticación](https://www.rainbowkit.com/docs/authentication), `siwe` todavía requerirá `ethers` como una dependencia peer.
