...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Function for calculating whether this wallet should be hidden from the list. Esto es útil para definir billeteras de reserva genéricas, por ejemplo, la reserva incorporada de "Injected Wallet" hace uso de esta función',
    },
    {
    ...
    },
    {
      ...
      typeSimple: 'object',
      description:
        'Objeto que contiene una función para resolver el URI del código QR, más instrucciones opcionales de configuración de billetera móvil',
    },
    {
      name: 'extension',
      required: false,
      ...
      typeSimple: 'object',
      description:
        'Objeto que contiene instrucciones opcionales de configuración de extensión de navegador',
    },
    {
      name: 'createConnector',
      required: true,
