...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Function for calculating whether this wallet should be hidden from the list. Esto es útil para definir billeteras de respaldo genéricas, por ejemplo, el respaldo integrado "Injected Wallet" hace uso de esta función.
