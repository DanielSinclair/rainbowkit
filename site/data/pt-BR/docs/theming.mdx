...
<PropsTable
  data={[
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description: 'O tamanho de toda a escala de raio de borda.',
    },
    {
      name: 'fontStack',
      required: false,
      ...
      typeSimple: 'enum',
      description:
        'A pilha de fontes usada em toda a interface do usuário. Note que `rounded` tenta usar SF Pro Rounded, recorrendo às fontes do sistema quando não está disponível.",
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'O desfoque do fundo modal.',
    },
  ]}
/>
