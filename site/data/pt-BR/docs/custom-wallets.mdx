...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Function for calculating whether this wallet should be hidden from the list. Isso é útil para definir carteiras genéricas de fallback, por exemplo, a carteira de fallback integrada 'Injected Wallet' faz uso dessa funcionalidade',
    },
    {
    ...
    },
    {
      ...
      type: '{ getUri?: (uri: string) => string }',
      typeSimple: 'object',
      description: 'Função para resolver um deep link de aplicativo de desktop',
    },
    {
      name: 'qrCode',
      required: false,
      ...
      typeSimple: 'object',
      description:
        'Objeto contendo uma função para resolver o URI do código QR, além de instruções opcionais de configuração da carteira móvel',
    },
    {
      name: 'extension',
      required: false,
