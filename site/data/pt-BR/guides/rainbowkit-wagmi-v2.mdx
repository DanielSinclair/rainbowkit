...
Os desenvolvedores continuam tendo controle total sobre a Lista de Carteiras Personalizadas para enfatizar carteiras preferenciais para os usuários finais. It is encouraged that you continue to include the `injectedWallet` and `walletConnectWallet` in your list to support all platforms.
