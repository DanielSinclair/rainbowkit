...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'string',
      description:
        'Warna yang digunakan untuk elemen latar depan yang dilukis di atas warna aksen.',
    },
    {
      name: 'borderRadius',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'Saiz skala radius sempadan keseluruhan.',
    },
    {
      name: 'fontStack',
      required: false,
      ...
      typeSimple: 'enum',
      description:
        'Tumpukan font yang digunakan di keseluruhan UI.',
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'Kesan kabur pada latar belakang modal.',
    },
  ]}
/>. Perhatikan bahawa `rounded` cuba menggunakan SF Pro Rounded, kembali kepada fon sistem apabila ia tidak tersedia.
