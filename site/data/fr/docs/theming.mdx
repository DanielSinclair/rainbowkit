...
<PropsTable
  data={[
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description:
        "La pile de polices utilisée dans toute l'interface utilisateur.",
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: "Le flou de l'arrière-plan modale.",
    },
  ]}
/>. Notez que `rounded` tente d'utiliser SF Pro Rounded, en revenant aux polices système s'il n'est pas disponible.",
    },
    {
      name: 'overlayBlur',
      required: false,
