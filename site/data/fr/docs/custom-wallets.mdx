...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Function for calculating whether this wallet should be hidden from the list. Cela est utile pour définir des portefeuilles de secours génériques, par exemple, le portefeuille de secours intégré "Injected Wallet" tire parti de cette fonctionnalité',
    },
    {
