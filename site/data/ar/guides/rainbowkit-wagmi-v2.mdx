...
يستمر المطورون في السيطرة الكاملة على قائمة المحافظ المخصصة لتسليط الضوء على المحافظ المفضلة للمستخدمين النهائيين. It is encouraged that you continue to include the `injectedWallet` and `walletConnectWallet` in your list to support all platforms.
