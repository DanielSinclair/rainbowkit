  ...
  data={[
    {
      ...
      type: 'string',
      description:
        'لون الخلفية/النص لعناصر تفاعلية مختلفة.',
    },
    {
      ...
      type: 'string',
      description:
        'اللون المستخدم لعناصر المقدمة التي تظهر فوق اللون المميز.',
    },
    {
      name: 'borderRadius',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'حجم المقياس الكامل لانحناء الحدود.',
    },
    {
      name: 'fontStack',
      required: false,
      ...
      typeSimple: 'enum',
      description:
        'مجموعة الخطوط المستخدمة في واجهة المستخدم.',
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: "تشويش خلفية النوافذ المتراكبة.",
    },
  ]}
/>. لاحظ أن `rounded` يحاول استخدام SF Pro Rounded، ويعود لاستخدام الخطوط النظامية عندما لا تكون متوفرة.",
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      type: '"large" | "small" | "none"',
      typeSimple: 'enum',
      description: 'التشويش الخلفي للنماذج.',
    },
  ]}
/>
