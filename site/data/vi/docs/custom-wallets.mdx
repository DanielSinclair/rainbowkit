...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Hàm tính toán xem ví này có nên bị ẩn khỏi danh sách không.',
    } 
  ]}
/> Điều này hữu ích cho việc xác định các ví dự phòng chung, ví dụ như ví dự phòng "Ví tiêm" tích hợp sử dụng tính năng này'.
    },
    {
