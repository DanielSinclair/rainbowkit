  ...
  data={[
    {
      ...
      type: 'string',
      description:
        'Màu nền/văn bản của các yếu tố tương tác khác nhau.',
    },
    {
      ...
      type: 'string',
      description:
        'Màu sắc được sử dụng cho các yếu tố tiền cảnh được dựng trên màu sắc chính.',
    },
    {
      name: 'borderRadius',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'Kích thước của toàn bộ tỷ lệ bán kính viền.',
    },
    {
      name: 'fontStack',
      required: false,
      ...
      type: '"rounded" | "system"',
      typeSimple: 'enum',
      description: 'Cấu trúc font được sử dụng trên toàn bộ giao diện người dùng.',
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'Độ mờ nền cho các cửa sổ lớp chồng. Note that `rounded` attempts to use SF Pro Rounded, falling back to system fonts when it isn't available.",
    },
    {
      name: 'overlayBlur',
      required: false,
