...
Các nhà phát triển tiếp tục có toàn quyền kiểm soát Danh sách Ví Tùy chỉnh để nhấn mạnh các ví ưa thích cho người dùng cuối. It is encouraged that you continue to include the `injectedWallet` and `walletConnectWallet` in your list to support all platforms.
