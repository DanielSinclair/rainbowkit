  ...
  data={[
    {
      ...
      type: 'string',
      description:
        'Çeşitli etkileşimli öğelerin arka plan/metin rengi.',
    },
    {
      ...
      type: 'string',
      description:
        'Aksan rengin üzerine yerleştirilen ön plan elemanları için kullanılan renk.',
    },
    {
      name: 'borderRadius',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'Tüm köşe yarıçapı ölçeğinin boyutu.',
    },
    {
      name: 'fontStack',
      required: false,
      ...
      typeSimple: 'enum',
      description:
        "UI genelinde kullanılan yazı tipi yığını.",
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'Modal arka plan bulanıklığı. Note that `rounded` attempts to use SF Pro Rounded, falling back to system fonts when it isn't available.",
    },
    {
      name: 'overlayBlur',
      required: false,
