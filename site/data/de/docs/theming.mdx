...
<PropsTable
  data={[
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description: "Der Hintergrundunschärfegrad für ein überlagertes Fenster.",
    },
  ]}
/>. Beachten Sie, dass `rounded` versucht, SF Pro Rounded zu verwenden und auf Systemschriftarten zurückgreift, wenn diese nicht verfügbar sind.",
    },
    {
      name: 'overlayBlur',
      required: false,
