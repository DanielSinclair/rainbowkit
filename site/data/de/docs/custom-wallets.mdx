...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: 'Funktion zur Berechnung, ob dieses Wallet in der Liste verborgen werden soll.',
    } 
  ]}
/> Dies ist nützlich für die Definition generischer Ersatz-Wallets, z. B. macht das integrierte "Injected Wallet"-Fallback von dieser Funktion Gebrauch',
    },
    {
