...
Hinweis: wagmi verwendet intern nicht mehr das Paket `ethers`. Wenn Sie jedoch auf die [Authentifizierungs-API](https://www.rainbowkit.com/docs/authentication) angewiesen sind, benötigt `siwe` weiterhin `ethers` als Peer-Abhängigkeit.
