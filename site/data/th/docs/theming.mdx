...
คุณสามารถปรับ UI ของ RainbowKit ให้ตรงกับแบรนด์ของคุณ คุณสามารถเลือกสีเน้นและการตั้งค่ารัศมีขอบจากที่กำหนดไว้ล่วงหน้า คุณสามารถเลือกสีเน้นและการตั้งค่ารัศมีขอบจากที่กำหนดไว้ล่วงหน้า
  ...
  data={[
    {
      ...
      type: 'string',
      description:
        'สีพื้นหลัง/ข้อความขององค์ประกอบที่โต้ตอบได้ต่างๆ',
    },
    {
      ...
      type: 'string',
      description:
        'สีที่ใช้สำหรับองค์ประกอบด้านหน้าที่เรนเดอร์อยู่บนสีพื้นหลัง',
    },
    {
      name: 'borderRadius',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'ขนาดของทั้งหมดของ scale รัศมีขอบ',
    },
    {
      name: 'fontStack',
      required: false,
      ...
      typeSimple: 'enum',
      description:
        "ชุดฟอนต์ที่ใช้ทั่วทั้ง UI." โปรดทราบว่า `rounded` พยายามใช้ SF Pro Rounded, หากไม่สามารถใช้ได้จะกลับไปใช้ฟอนต์ระบบเริ่มต้นแทน",
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'การเบลอพื้นหลังของ modal.',
    },
  ]}
/>
...
แต่ละธีมยังให้คำประกอบสีเฉพาะ (`blue`, `green`, `orange`, `pink`, `purple`, `red`) ที่สามารถแพร่ไปในวัตถุตัวเลือก ตัวอย่างเช่น การใช้คำประกอบสี `pink`: ตัวอย่างเช่น การใช้คำประกอบสี `pink`:
