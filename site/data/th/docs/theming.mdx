...
แต่ละธีมยังให้คำประกอบสีเฉพาะ (`blue`, `green`, `orange`, `pink`, `purple`, `red`) ที่สามารถแพร่ไปในวัตถุตัวเลือก ตัวอย่างเช่น การใช้คำประกอบสี `pink`: ตัวอย่างเช่น การใช้คำประกอบสี `pink`: ตัวอย่างเช่น การใช้คำประกอบสี `pink`: ตัวอย่างเช่น การใช้คำประกอบสี `pink`: ตัวอย่างเช่น การใช้คำประกอบสี `pink`: ตัวอย่างเช่น การใช้คำประกอบสี `pink`:
