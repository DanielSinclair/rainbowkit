  ...
  data={[
    {
      ...
      type: 'string',
      description:
        'สีของพื้นหลัง/ตัวอักษรขององค์ประกอบที่โต้ตอบได้ต่างๆ',
    },
    {
      ...
      type: 'string',
      description:
        'สีที่ใช้สำหรับองค์ประกอบเบื้องหน้าเหนือสีเน้น',
    },
    {
      name: 'borderRadius',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'ขนาดของมาตราส่วนรัศมีขอบทั้งหมด',
    },
    {
      name: 'fontStack',
      required: false,
      ...
      typeSimple: 'enum',
      description:
        'กองตัวอักษรที่ใช้ใน UI ทั้งหมด',
    },
    {
      name: 'overlayBlur',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'การเบลอพื้นหลังของโมดัล Note that `rounded` attempts to use SF Pro Rounded, falling back to system fonts when it isn't available."
    },
    {
      name: 'overlayBlur',
      required: false,
