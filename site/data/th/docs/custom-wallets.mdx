...
ฟังก์ชันประเภท `Wallet` ได้รับการให้เพื่อช่วยคุณกำหนดกระเป๋าเงินที่กำหนดเองของคุณเอง ฟังก์ชันประเภท `Wallet` ได้รับการให้เพื่อช่วยคุณกำหนดกระเป๋าเงินที่กำหนดเองของคุณเอง คุณสามารถกำหนดค่าทรัพย์สินต่อไปนี้บนค่าที่คืนกลับของฟังก์ชัน `Wallet` ของคุณ:
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        '","context":"","maxLength":null},{ This is useful for defining generic fallback wallets, e.g. the built-in "Injected Wallet" fallback makes use of this feature',
    },
    {
