...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Function for calculating whether this wallet should be hidden from the list. นี่เป็นประโยชน์สำหรับการกำหนดกระเป๋าเงินแบบเฉพาะทั่วไป, เช่น การใช้งานฟังก์ชัน "Injected Wallet" ที่เป็นตัวเลือกมาตรฐานทำให้สามารถใช้คุณสมบัตินี้ได้',
    },
    {
