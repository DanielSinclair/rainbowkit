...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'URL สำหรับไอคอนกระเป๋าเงิน, หรือ promise ที่แก้ไขเป็น Base64 data URL',
    },
    {
      name: 'iconAccent',
      required: false,
      type: 'string',
      description:
        'สีเน้นที่ใช้ในกระบวนการดาวน์โหลดสำหรับกระเป๋าเงินที่มีทั้งส่วนขยายเบราว์เซอร์และแอปมือถือ',
    },
    {
      name: 'iconBackground',
      required: true,
      type: 'string',
      description: 'สีพื้นหลังขณะที่ไอคอนกระเป๋าเงินกำลังโหลด',
    },
    {
      name: 'installed',
      required: false,
      ...
      description: (
        <>
          ไม่ว่ากระเป๋าเงินจะเป็นที่รู้จักว่าได้รับการติดตั้งแล้ว, หรือ{' '}
          <code>undefined</code> ถ้าไม่แน่นอน
        </>
      ),
    },
    {
      ...
      description: 'อ็อบเจกต์ที่มี URL ดาวน์โหลด',
    },
    {
      name: 'hidden',
      required: false,
      ...
      description:
        'ฟังก์ชันสำหรับการคำนวณว่ากระเป๋าเงินนี้ควรจะถูกซ่อนจากรายการหรือไม่. นี่เป็นประโยชน์สำหรับการกำหนดกระเป๋าเงินแบบเฉพาะทั่วไป, เช่น การใช้งานฟังก์ชัน "Injected Wallet" ที่เป็นตัวเลือกมาตรฐานทำให้สามารถใช้คุณสมบัตินี้ได้',
    },
    {
      ...
      description:
        'ฟังก์ชันสำหรับการให้ตัวอย่าง connector และการกำหนดค่าสำหรับวิธีการเชื่อมต่อที่แตกต่างกัน, อธิบายด้านล่าง',
    },
    {
      name: 'mobile',
      required: false,
    ...
    },
    {
      ...
      type: '{ getUri?: (uri: string) => string }',
      typeSimple: 'object',
      description: 'ฟังก์ชันสำหรับการแก้ไขลิงก์ลึกแอปพลิเคชันเดสก์ท็อป',
    },
    {
      name: 'qrCode',
      required: false,
      ...
      typeSimple: 'object',
      description:
        'อ็อบเจกต์ที่มีฟังก์ชันสำหรับการแก้ไข URI ของ QR code, บวกกับคำแนะนำการตั้งค่ากระเป๋าเงินมือถือที่เป็นตัวเลือก',
    },
    {
      name: 'extension',
      required: false,
      ...
      typeSimple: 'object',
      description:
        'อ็อบเจกต์ที่มีคำแนะนำการตั้งค่าส่วนขยายเบราว์เซอร์ที่เป็นตัวเลือก',
    },
    {
      name: 'createConnector',
      required: true,
      ...
      description: 'ฟังก์ชันสำหรับการให้ตัวอย่าง connector',
    },
  ]}
/>
