...
กำหนดค่าสำหรับเชื่อมโยงที่คุณต้องการและสร้างเชื่อมโยงที่ต้องการ คุณยังต้องการตั้งค่ากำหนดค่า `wagmi` If your dApp uses server side rendering (SSR) make sure to set `ssr` to `true`.
