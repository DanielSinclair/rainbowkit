...
> หมายเหตุ: ทุก dApp ที่ใช้ WalletConnect ตอนนี้ต้องได้รับ `projectId` จาก [WalletConnect Cloud](https://cloud.walletconnect.com/) นี่เป็นบริการฟรีและใช้เวลาไม่กี่นาที นี่เป็นบริการฟรีและใช้เวลาไม่กี่นาที นี่เป็นบริการฟรีและใช้เวลาไม่กี่นาที นี่เป็นบริการฟรีและใช้เวลาไม่กี่นาที นี่เป็นบริการฟรีและใช้เวลาไม่กี่นาที นี่เป็นบริการฟรีและใช้เวลาไม่กี่นาที
