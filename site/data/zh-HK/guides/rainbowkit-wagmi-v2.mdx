...
開發者仍擁有完全控制自定義錢包清單的權限，以強調優先的錢包給終端用戶。 It is encouraged that you continue to include the `injectedWallet` and `walletConnectWallet` in your list to support all platforms.
