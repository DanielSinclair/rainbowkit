...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: (
        <>
          以3個有效數字格式化的餘額，加上符號，例如 <code>1.23 ETH</code>
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      description: (
        <>
          ENS名稱，例如 <code>rainbowwallet.eth</code>
        </>
      ),
    },
    {
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'string | undefined',
      description:
        '鏈圖標的 URL（當下載 Base64 資料 URL 時也可能未定義）',
    },
    {
