  ...
  data={[
    {
      ...
      type: 'string',
      description:
        'विभिन्न इंटरएक्टिव तत्वों का पृष्ठभूमि/पाठ रंग।',
    },
    {
      ...
      type: 'string',
      description:
        'मुख्य रंग के ऊपर प्रदर्शित तत्वों के लिए उपयोग किया जाने वाला रंग।',
    },
    {
      name: 'borderRadius',
      required: false,
      ...
      typeSimple: 'enum',
      description: 'पूरे सीमा-त्रिज्या स्केल का आकार।',
    },
    {
      name: 'fontStack',
      required: false,
      ...
      typeSimple: 'enum',
      description:
        'UI में उपयोग किया गया फॉन्ट स्टैक।',
    },
  ]}
/> यह नोट करें कि `rounded` SF Pro Rounded का उपयोग करने का प्रयास करता है, उपलब्ध न होने पर सिस्टम फ़ॉन्ट्स पर वापस जाता है।
