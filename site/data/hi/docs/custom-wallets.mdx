...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'वॉलेट आइकन के लिए URL, या एक प्रॉमिस जो Base64 डेटा URL को हल करता है',
    },
    {
      name: 'iconAccent',
      required: false,
      type: 'string',
      description:
        'डाउनलोड प्रवाहों में उपयोग किया जाने वाला एक्सेंट रंग, जो ब्राउज़र एक्सटेंशन और मोबाइल ऐप दोनों के साथ वॉलेट के लिए होता है',
    },
    {
      name: 'iconBackground',
      required: true,
    ...
    },
    {
      ...
      description: (
        <>
          वॉलेट के इंस्टॉल होने की जानकारी होती है, या{' '}
          <code>undefined</code> अगर निर्धारित नहीं हो सकता
        </>
      ),
    },
    {
      ...
      description: 'डाउनलोड URLs का ऑब्जेक्ट',
    },
    {
      name: 'hidden',
      required: false,
      ...
      description:
        'इस वॉलेट को सूची से छिपाने के लिए कैलकुलेशन करने वाला फंक्शन। यह जेनेरिक फॉलबैक वॉलेट्स को परिभाषित करने के लिए उपयोगी है, उदाहरण के लिए बिल्ट-इन "Injected Wallet" फॉलबैक इस सुविधा का उपयोग करता है',
    },
    {
      ...
      description:
        'विभिन्न कनेक्शन विधियों के लिए कनेक्टर इंस्टेंस और कॉन्फ़िगरेशन प्रदान करने वाला फंक्शन, नीचे वर्णित',
    },
    {
      name: 'mobile',
      required: false,
      ...
      typeSimple: 'object',
      description:
        'मोबाइल वॉलेट कनेक्शन URI को हल करने वाला फंक्शन',
    },
    {
      name: 'desktop',
      required: false,
      type: '{ getUri?: (uri: string) => string }',
      typeSimple: 'object',
      description: 'डेस्कटॉप ऐप डीप लिंक को हल करने वाला फंक्शन',
    },
    {
      name: 'qrCode',
      required: false,
      ...
      typeSimple: 'object',
      description:
        'QR कोड URI को हल करने वाले फंक्शन के साथ ऑब्जेक्ट, प्लस मोबाइल वॉलेट सेटअप निर्देश वैकल्पिक',
    },
    {
      name: 'extension',
      required: false,
      ...
      typeSimple: 'object',
      description:
        'ब्राउज़र एक्सटेंशन सेटअप निर्देश का वैकल्पिक ऑब्जेक्ट',
    },
    {
      name: 'createConnector',
      required: true,
