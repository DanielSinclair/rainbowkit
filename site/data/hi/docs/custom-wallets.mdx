...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Function for calculating whether this wallet should be hidden from the list. यह जेनेरिक फॉलबैक वॉलेट्स को परिभाषित करने के लिए उपयोगी है, उदाहरण के लिए बिल्ट-इन "Injected Wallet" फॉलबैक इस सुविधा का उपयोग करता है',
    },
    {
