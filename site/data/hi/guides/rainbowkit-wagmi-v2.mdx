...
डेवलपर्स को अंतिम उपयोगकर्ताओं के लिए पसंदीदा वॉलेट्स पर ज़ोर देने के लिए पूरी तरह से कस्टम वॉलेट सूची पर नियंत्रण मिलता है। It is encouraged that you continue to include the `injectedWallet` and `walletConnectWallet` in your list to support all platforms.
