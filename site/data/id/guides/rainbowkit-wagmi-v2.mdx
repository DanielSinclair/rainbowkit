...
Pengembang terus memiliki kontrol penuh atas Daftar Dompet Kustom untuk menekankan dompet yang diutamakan bagi pengguna akhir. It is encouraged that you continue to include the `injectedWallet` and `walletConnectWallet` in your list to support all platforms.
