...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: true,
      type: 'string',
      description: 'Warna latar belakang saat ikon dompet sedang dimuat',
    },
    {
      name: 'installed',
      required: false,
    ...
    },
    {
      ...
      description:
        'Fungsi untuk menghitung apakah dompet ini harus disembunyikan dari daftar.' Ini berguna untuk mendefinisikan dompet cadangan generik, misalnya fallback dompet "Injected Wallet" bawaan memanfaatkan fitur ini',
    },
    {
      ...
      description:
        'Fungsi untuk menyediakan instansi konektor dan konfigurasi untuk berbagai metode koneksi, yang dijelaskan di bawah ini',
    },
    {
      name: 'mobile',
      required: false,
    ...
    },
    {
      ...
      typeSimple: 'object',
      description:
        'Objek yang berisi instruksi opsional untuk pengaturan ekstensi browser',
    },
    {
      name: 'createConnector',
      required: true,
