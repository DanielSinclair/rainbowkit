...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Function for calculating whether this wallet should be hidden from the list. Ini berguna untuk mendefinisikan dompet cadangan generik, misalnya fallback dompet "Injected Wallet" bawaan memanfaatkan fitur ini',
    },
    {
