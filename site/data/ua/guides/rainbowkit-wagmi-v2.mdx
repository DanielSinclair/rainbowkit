...
Розробники продовжують мати повний контроль над Кастомним Списком Гаманців для надання переваги обраним гаманцям для кінцевих користувачів. It is encouraged that you continue to include the `injectedWallet` and `walletConnectWallet` in your list to support all platforms.
