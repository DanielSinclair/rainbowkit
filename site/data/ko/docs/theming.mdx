...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'string',
      description:
        '강조 색상 위에 렌더링되는 전경 요소에 사용되는 색상입니다.',
    },
    {
      name: 'borderRadius',
      required: false,
    ...
    },
    {
      ...
      typeSimple: 'enum',
      description:
        'UI 전반에 사용되는 폰트 스택입니다. Note that `rounded` attempts to use SF Pro Rounded, falling back to system fonts when it isn't available.
