...
개발자는 최종 사용자에게 선호하는 지갑을 강조하기 위해 사용자 지정 지갑 목록을 완전히 제어할 수 있습니다. It is encouraged that you continue to include the `injectedWallet` and `walletConnectWallet` in your list to support all platforms.
