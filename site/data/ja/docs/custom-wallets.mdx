...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Function for calculating whether this wallet should be hidden from the list. これは、一般的なフォールバックウォレットを定義するのに役立ちます。例えば、組み込まれた「Injected Wallet」フォールバックはこの機能を利用しています',
    },
    {
      ...
      description:
        '異なる接続方法のコネクタインスタンスと設定を提供する関数、以下に説明',
    },
    {
      name: 'mobile',
      required: false,
    ...
    },
    {
      ...
      typeSimple: 'object',
      description:
        'QRコードURIを解決する関数を含むオブジェクト、およびオプションのモバイルウォレット設定手順',
    },
    {
      name: 'extension',
      required: false,
