...
小さいスクリーンでは、アカウントのアイコンのみを表示します。 しかし、大きなスクリーンでは、アイコンとアドレスを表示します。 しかし、大きなスクリーンでは、アイコンとアドレスを表示します。 しかし、大きなスクリーンでは、アイコンとアドレスを表示します。 しかし、大きなスクリーンでは、アイコンとアドレスを表示します。 しかし、大きなスクリーンでは、アイコンとアドレスを表示します。
