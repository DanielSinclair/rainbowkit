...
開發者繼續擁有完全控制自定義錢包列表的權限，以強調終端用戶的首選錢包。 It is encouraged that you continue to include the `injectedWallet` and `walletConnectWallet` in your list to support all platforms.
