---
title: ConnectButton
description: 使用和自定義 ConnectButton
---

# ConnectButton

## 使用和自定義 ConnectButton

這是主要的元件。 它負責渲染連接/斷開連接按鈕以及鏈交換 UI。
...
> 注意：確保您的應用程序包裹在必要的提供者內。 [閱讀更多](/docs/installation#wrap-providers)。

### 屬性

`ConnectButton` 元件公開了幾個屬性來自定義其外觀，包括切換不同元素的可見性。
